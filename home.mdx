...
<CardGroup cols={3}>
  ...
  <Card title="Service Provider" icon="screwdriver-wrench" iconType="duotone" href="/s/topic/0TO5e000000h9wpGAA/service-provider-help-guides">
    - [Getting Started](/s/topic/0TO5e000000h9wpGAA/service-provider-help-guides#getting-started)
    - [Work Order Management](/s/topic/0TO5e000000h9wpGAA/service-provider-help-guides#work-order-management)
    - [Estimates, Invoicing & Documentation](-/s/topic/0TO5e000000h9wpGAA/service-provider-help-guides#estimates%2C-invoicing-%26-documentation)
  </Card>
</CardGroup>
