...
<Frame>
  ...
  <Tip>
    If the service provider will only work on certain properties or territories, you can also add the territories from your existing properties in Latchel, or manually add zip codes. Check [**<u>How to Assign Service Provider to a Territory / Zip Code</u>**](https://help.latchel.com/s/topic/0TO5e000000h9wqGAA/How-to-Assign-Service-Provider-to-a-Territory-Zip-Code)**<u> </u>**to learn more\!
  </Tip>
</Frame>
