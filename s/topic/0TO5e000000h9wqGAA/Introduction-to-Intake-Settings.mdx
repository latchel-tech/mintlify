...
- Rules can also route a request to Contact On-Call instead of a standard work order, but this outcome only works if your company is subscribed to the ER-SaaS-RBP package with the "Include On-Call" toggle enabled.