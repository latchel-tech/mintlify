...
- Rules can also route a request to Contact Rotations instead of a standard work order, but this outcome only works if your company is subscribed to the ER-SaaS-RBP package with the "On-Call" enabled.