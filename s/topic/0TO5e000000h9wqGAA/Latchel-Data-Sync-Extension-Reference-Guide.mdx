...
<Frame>
  <img src="/images/rtaImage-343.jpg"/>
</Frame>
...
**NOTE:** _Users can stop WOs from updating by using the Assigned Work Orders setting and unassigning the Latchel user in your PMS._

**To know more about the Integration Sync Method and set which option works best for your company, please contact Latchel.**
...
1.  **Properties -** status of previously created properties synchronizes _**only from active to inactive.**_ This means that if you activates a previously inactive property from your PMS, **this change will not propagate to Latchel.**

**NOTE:** _Chrome plugin users can influence the "is_active" field of a property by hiding or unhiding the object in your PMS._
...
<Frame>
  <img src="/images/rtaImage-344.jpg"/>
</Frame>
