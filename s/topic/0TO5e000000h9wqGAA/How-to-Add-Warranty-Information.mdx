...
<Warning>
  - This setting **does not** apply to **emergency situations**—Latchel will continue to dispatch emergencies as needed. Additionally, Latchel **does not** **coordinate** with **Home Warranty companies**. 
