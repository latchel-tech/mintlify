...
<Check>
  If Bob makes any changes to resident data in his main software, the changes are **automatically** reflected in **Latchel 1-4 hours later**, depending on your platform.
</Check>

<Frame>
  ![](/images/rtaImage-673.jpg)
</Frame>
...
- After that, scheduled syncs occur every 1-4 hours (depending on your platform), on the 5-minute mark (e.g. 08:05 AM).
