...
### **Property Assignee Sync**

**Property Assignee sync:** When work orders sync from Latchel to Rentvine, the Rentvine work order's property assignee can now be automatically updated based on the Rentvine lease assignee. This is available on request — submit a feature request to your Customer Success Manager to enable it for your account.