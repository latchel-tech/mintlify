...
1. **Sewage/Standing Water Issues**
...
The ***work order problems*** corresponding to sewage/standing water issues regardless of location are:
...
The ***work order problems*** corresponding to no outside heat issues regardless of location are:
...
The ***work order problem*** corresponding to electrical outlet issue regardless of location is:
...
The ***work order problem*** corresponding to this type of issue is: 

* No Running Water

1. **Broken Door/Lock Issue**
