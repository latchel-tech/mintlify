...
The _**work order problems**_ corresponding to plumbing or any water leak issues regardless of location are:
...
The _**work order problems**_ corresponding to sewage/standing water issues regardless of location are:
...
The _**work order problems**_ corresponding to no outside heat issues regardless of location are:
...
The _**work order problem**_ corresponding to electrical outlet issue regardless of location is:
...
The _**work order problem**_ corresponding to this type of issue is: 
...
The _**work order problems**_ corresponding to 911 Emergencies regardless of location are:
