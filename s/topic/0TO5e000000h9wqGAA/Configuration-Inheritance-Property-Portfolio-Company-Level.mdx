...
<Note>
  Please note: The “**copy**” must be maintained separately from the company or portfolio levels. You will have 2 independent lists to manage. Preferences updates and the level that was copied will NOT transfer to the level that received the copied priorities.
</Note>
...
[How to Configure a Property with Default Access Instructions  <br/>How to Update Your Escalation Contacts](/s/topic/0TO5e000000h9wqGAA/How-to-Update-Your-Escalation-Contacts)
