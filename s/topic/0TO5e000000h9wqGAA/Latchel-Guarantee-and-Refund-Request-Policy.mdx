...
2. **Eligibility for Refunds**
   ...
   <Danger>
     ...
     - Appointment/service fee invoices for confirmed appointments missed by the resident (when no Permission To Enter is given).
   </Danger>
...
### **Payment Authority & Provider Classification**

Latchel works with **two types of service providers**:

1. **Latchel Service Providers (Latchel Vendor Network & Latchel Contractor Network)**\
   These providers must always be paid by Latchel. Property Managers and Property Owners may not pay Latchel Service Providers directly. Any direct payment made outside of Latchel creates a risk of duplicate payment and does not negate Latchel’s obligation to pay the service provider unless valid proof of payment is received and confirmed.
2. **Preferred Service Providers**\
   Preferred Service Providers may be paid either by Latchel or directly by the Property Manager, depending on the payment settings configured by the Property Manager and the service provider in Latchel. These providers operate outside of the Latchel Vendor Network and are not covered by Latchel’s workmanship guarantee or parts warranty.

To check **frequently asked questions** on how Latchel manages invoicing and payments for these service providers, visit:

<Card title="Invoicing and Handling Payments for Service Providers" icon="hand-holding-dollar" iconType="duotone" color="#ff9b8a" href="/s/topic/0TO5e000000h9wqGAA/Invoicing-Preferred-Service-Provider-vs-LCN">
  Overview of how invoicing and payments are processed for service providers.
</Card>

### **Resident Benefits**

**Would you like to know what feature and benefits Latchel offers to your residents?** Check the article below:

<Card title="Accessing Your Resident Benefits Hub |  What are its feature and benefits?" icon="clipboard-list-check" iconType="duotone" href="https://help.latchel.com/s/topic/0TO5e000000h9wrGAA/Accessing-Your-Resident-Benefits-Hub#what-are-its-feature-and-benefits%3F">
  Know what Latchel offers to your residents. Check this!
</Card>