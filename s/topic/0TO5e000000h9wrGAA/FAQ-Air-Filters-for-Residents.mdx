...
<Note>
  **NOTE:** *Before submitting a request for a free air filter, please confirm with your property management company whether this resident benefit is included in their Latchel subscription. If confirmed, kindly complete the Typeform. Please note that only eligible residents are entitled to receive free air filters.*
</Note>
...
<AccordionGroup>
  <Accordion title="How do I locate where my air filter(s) are in my home?">
  ...
  <Accordion title="How do I determine the size of my air filter(s)?">
    In this video, a professional shows how to locate and measure a filter: **[What Size Air Filter Do I need? | Filter Time](https://youtu.be/X-NTd8xZFzA?si=xD5AUSQSRQ_mFILy)**
  ...
  <Accordion title="How do I submit my filter information to Latchel?">
    Please complete this **[Typeform](https://latchel.typeform.com/to/ve5O9pds)**.
  </Accordion>

  <Accordion title="When will I receive my filter shipments?">
  ...
  <Accordion title="What should I do if I receive damaged, wrong, missing or no filters?">
