...
<CardGroup cols={2}>
  <Card title="Damaged, wrong, missing, no filter? Fill out this typeform." icon="message-pen" iconType="duotone" horizontal href="https://latchel.typeform.com/to/lKZfspdn">
