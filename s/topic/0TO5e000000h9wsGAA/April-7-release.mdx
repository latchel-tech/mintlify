...
The Latchel Data Sync ([<u>version 3.1.1</u>](https://chromewebstore.google.com/detail/latchel-data-sync/cefobanegfgmcneibgdbcjbegnnoafob)) has a few powerful enhancements to give you more control and transparency over your data synchronization.
